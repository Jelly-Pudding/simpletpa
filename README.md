# SimpleTPA Plugin
**SimpleTPA** is a Minecraft Paper 26.3 plugin that implements teleport request functionality. Although it was custom built for [minecraftoffline.net](https://www.minecraftoffline.net), any server can use it.
